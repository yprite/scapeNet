...
#ipboard{position: absolute; width: 700px; top:60px; height: 200px; right: 360px; float: right; background: black;border-radius: 15px;-moz-border-radius: 15px;-webkit-border-radius: 15px;-webkit-filter: blur(5px);filter: blur(5px); opacity: .92; display: none; }
#ipboard_content{position: absolute; width: 665px; top:75px; height: 200px; right: 380px; float: right;display: none;text-align: center;}
...
#input_search{border: none;border-radius: 7px;-moz-border-radius: 7px;-webkit-border-radius: 7px; outline: none; width: 98%}
...
*/
	...
	function init(){
		...
		$('#ipboard_content').height($(window).height() - $('#ipboard_content').offset().top-60);
...
if(parseInt($('#load_node_'+nn+'_status').html()) == 1){
	create_node(nn,-random_number(80)+random_number(80),random_number(80),random_number(50)-random_number(50),$('#load_node_'+nn+'_ip').html());
}else{
	// alert('0');
}
}					
...
if(parseInt($('#load_node_'+nn+'_status').html()) == 1 || parseInt($('#load_node_'+nn+'_status').html()) == 2 ||parseInt($('#load_node_'+nn+'_status').html()) == 3){
	...
	create_node(nn,-random_number(90)+random_number(90),random_number(90),random_number(90)-random_number(50),$('#load_node_'+nn+'_ip').html());
	}
}else{
...
<font size="4" color="#c6c6c6" ><strong>IP Monitoring Board</strong></font>
	<table style="font-size:12px; width:100%; opacity:.5">
				<?php
				...
				for($i=0;$i<17;$i++){
					...
					<tr style="border:1px solid black;">
						...
						$this_id = $i*15+$j+1;
							?>
							<td class="td_node td_board" bgcolor="#373737" style="height:25px; width:5px; cursor:pointer; color:white" alt="<?=$this_id?>">
							</td>
							<?php
						}
						?>
	...
	IP Status / <span id="btn_ipmornitor">NEW</span><br />
	<div id="node_search">
