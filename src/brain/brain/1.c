...
//							temp_u = user_info[ip].up_traffic_cur;
							...
							if(isTime == 2){
								if((user_info[ip].up_traffic_cur/60 > atoi(user_info[ip].up_traffic_limit))&&user_info[ip].isStatus<2){
...
//							printf("ip(%d) dw , %d\n",ip,user_info[ip].down_traffic_cur);
							...
							if(isTime == 2){
								...
								if((user_info[ip].down_traffic_cur / 60  > atoi(user_info[ip].down_traffic_limit))&&user_info[ip].isStatus<2){
